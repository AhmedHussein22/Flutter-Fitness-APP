...
class _OnBordingState extends State<OnBording> {
  ...
  image: Center(child: Image.asset("assets/images/screen1.jpg", 
  height: 500,
  width: 700,
  )
  ),
...
PageViewModel(
  title: "Discipline",
  body: " Discipline comes from the willingness to learn, grow, and listen....",
  image: Center(child: Image.asset("assets/images/screen2.png", height: 400,width: 500,)),
  decoration: const PageDecoration(
    bodyTextStyle: TextStyle(fontSize: 15, color: Colors.white, ),
    titleTextStyle:TextStyle(fontSize: 24, color: Color(0Xffff0e30),fontWeight: FontWeight.bold) ,
...
PageViewModel(
  title: "Respect",
  body: "it is just as courageous to stop at the right time as it is to fight through setbacks when the timing is right....",
  image: Center(child: Image.asset("assets/images/screen3.png", height: 500,width: 500,)),
   decoration: const PageDecoration(
    bodyTextStyle: TextStyle(fontSize: 15, color: Colors.white, ),
    titleTextStyle:TextStyle(fontSize: 24, color: Color(0Xffff0e30),fontWeight: FontWeight.bold) ,
...
PageViewModel(
  title: "Purpose",
  body: "Purpose is the why behind your goal....",
  image: Center(child: Image.asset("assets/images/screen4.png",height: 500,width: 500,)),
  decoration: const PageDecoration(
    bodyTextStyle: TextStyle(fontSize: 15, color: Colors.white, ),
    titleTextStyle:TextStyle(fontSize: 24, color: Color(0Xffff0e30),fontWeight: FontWeight.bold) ,
  ...
  showSkipButton: true,
  skip: const Icon(Icons.cancel,color: Colors.white,size: 40,),
  done: const Text("Done", style: TextStyle(fontWeight: FontWeight.w600,color: Colors.white)),
  dotsDecorator: DotsDecorator(
      size: const Size.square(10.0),
      activeSize: const Size(20.0, 10.0),
